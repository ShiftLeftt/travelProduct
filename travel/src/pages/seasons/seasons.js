    ...
    return (
        <div className={style.seasonsContainer}>
            ...
            <div className={style.slideContainer}>
                <Swiper ref={swiperRef} spaceBetween={20} slidesPerView={3} loop={true} navigation={{prevEl: prevRef.current, nextEl: nextRef.current}} modules={[Navigation]} className={style.swiperContainer}>
                ...
                <div ref={prevRef} className={`${style.prevBtn} swiper-button-prev`}><TfiAngleLeft /></div>
                <div ref={nextRef} className={`${style.nextBtn} swiper-button-next`}><TfiAngleRight /></div>
            </div>
        </div>
    )}

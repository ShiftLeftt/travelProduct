...
function Main({children}) {
  ...
  const handleClick = (menu) => {
    setActiveHeader((activeMenu) => (activeMenu === menu ? null : menu))
  }
  ...
  return (
      <div className={style.mainDiv}>
          <header>
              <ul className='menu'>
                  <li>
                      <NavLink to="/" className={({ isActive }) => (isActive ? "active" : "nav-link")} onClick={()=>handleClick('home')}>
                  ...
                  <li>
                    <NavLink to="/Seasons" className={({ isActive }) => (isActive ? "active" : "nav-link")} onClick={()=>handleClick('seasons')}>
                      추천지
                    </NavLink>
                    <div></div>
                  </li>
                  <li>
                    <NavLink to="/Community" className={({ isActive }) => (isActive ? "active" : "nav-link")} onClick={()=>handleClick('community')}>커뮤니티</NavLink>
                    <div></div>
                  </li>
                  <li>
                    <NavLink to="/Random" className={({ isActive }) => (isActive ? "active" : "nav-link")} onClick={()=>handleClick('random')}>랜덤여행지</NavLink>
                    <div></div>
                  </li>
              </ul>
          </header>

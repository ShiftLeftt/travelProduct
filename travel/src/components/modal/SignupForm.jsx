            ...
            <form onSubmit={handleSubmit}>
                <div className={styles.inputGroup}>
                    ...
                    <div className={styles.inputWithButton}>
                        ...
                        />
                        <button type="button" onClick={duplicationId} className={styles.verifyButton}>중복확인</button>
                    </div>
                </div>
                ...
                <div className={styles.inputGroup}>
                    ...
                    <div className={styles.inputWithButton}>
                        <input
                            ...
                            className={styles.input}
                        />
                        <button type="button" onClick={emailVerification} className={styles.verifyButton}>인증하기</button>
                    </div>
                </div>

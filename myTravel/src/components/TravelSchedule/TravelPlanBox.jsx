...
export default function TravelPlanBox({
  formatDate,
  getDuration,
  onClose,
  markers,
  ...
  const { places, pagination, searchPage } = useSearch(
    searchKeyword,
    map,
    center,
    5000
  ...
  return (
    <div
      className={`${styles.travelPlanBox} ${
        step ? styles.travelPlanBoxVisible : ""
      }`}
    >
          ...
          <>
            ...
            <div className={styles.calendar}>
              <Calendar
                ...
                tileClassName={({ date }) => {
                  ...
                  if (isSameDay(date, nextToStart))
                    return "inRange leftRounded";
            ...
            {selectedDates.length === 2 && (
              <div className={styles.selectedDateInfo}>
                ...
                <span className={styles.selectedDatePoint}>
                  {getDuration()}
                </span>
              </div>
            )}
              ...
              <div className={styles.citySelect}>
                ...
                >
                  ...
                  <img
                    ...
                    alt="dropdown"
                    className={styles.cityDropdownIcon}
                  />
                </button>
            ...
            <button className={styles.nextBtn} onClick={handleSelect}>
              다음 단계
            </button>
          </>
        )}
        {step === 2 && (
          <>
            ...
            <div className={styles.tabWrapper}>
              <button
                className={`${styles.tabLocation} ${
                  tab === "select" ? styles.active : ""
                }`}
              ...
              <>
                ...
                <div className={styles.tabMenu}>
                  {["명소", "음식", "카페"].map((name) => (
                    <button
                      key={name}
                      className={
                        activeTab === name ? styles.activeTab : styles.tab
                      }
                      onClick={() => {
                        setActiveTab(name);
                ...
                <div className={styles.tabContent}>
                  ...
                  <SearchList
                    ...
                    onItemHover={(place, idx) =>
                      setHoveredPlace({ place, idx })
                    }
            ...
            <button className={styles.confirmedBtn} onClick={onClose}>
              플랜확정
            </button>
          </>
        )}
